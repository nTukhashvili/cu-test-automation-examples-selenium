...
public class Task_2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id='gender']/div[@class='form-check-inline'][2]")).click();
        ...
        // ველოდებით მანამ სანამ target ელემენტში მეორე არგუმენტად გადაწოდებული ტექსტი არ გამოჩნდება
